...
func SetupRouter(
	...
	// Observe the original inbound body before any size limiter or model-routing
	// middleware prereads it. Responses stage logs use this to separate client
	// upload time from routing and upstream latency.
	r.Use(middleware2.RequestBodyTiming())
