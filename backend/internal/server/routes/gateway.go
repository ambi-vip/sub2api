...
func RegisterGatewayRoutes(
	...
	largeRequestConcurrency := h.OpenAIGateway.LargeRequestConcurrencyMiddleware()
	...
	gateway.Use(largeRequestConcurrency)
	...
	rootRoute := func(method, path string, limit gin.HandlerFunc, handler gin.HandlerFunc) {
		r.Handle(method, path, limit, largeRequestConcurrency, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, compositeTarget, requireGroupAnthropic, handler)
	}
	...
	codexDirect.Use(bodyLimit, largeRequestConcurrency, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), groupModelAllowlist, compositeTarget, requireGroupAnthropic)
	{
