...
// is immediately before native_compaction_v2; latency_breakdown is appended
// after created_at so existing column positions remain stable.
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	...
	// Tail order: session_id, native_compaction_v2, created_at, latency_breakdown.
