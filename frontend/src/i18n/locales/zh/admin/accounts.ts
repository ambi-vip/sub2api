export default {
    accounts: {
      ...
      modelTrace: {
        ...
        allHint: '检测系统中的全部账号',
        selected: '已选账号',
        selectedHint: '检测当前选择的 {count} 个账号',
        selectedAccounts: '账号 ID',
        accountIdsPlaceholder: '输入账号 ID，使用逗号、空格或换行分隔',
        detectionModel: '检测模型',
        backendDefaultModel: '后台默认模型（{model}）',
        platformDefaultModel: '按账号平台自动选择',
        customModel: '自定义模型 ID',
        customModelPlaceholder: '例如：gpt-5.4 或 claude-sonnet-4-6',
        detectionModelHint: '可直接选择模型；“后台默认模型”使用功能开关中的配置，未配置时按账号平台使用系统默认模型。',
        resultSearchPlaceholder: '搜索账号、模型或归因结果',
        resultFilterAll: '全部',
        resultFilterSuccess: '检测成功',
        resultFilterFailed: '检测失败',
        clearResults: '清空结果',
        showingResults: '显示 {shown} / {total}',
        noMatchingResults: '没有匹配的检测结果',
        group: '指定分组',
        groupHint: '检测所选分组中的全部账号',
        selectGroup: '选择分组',
        usageNotice: '每个账号目标收集 3 份有效回答，最多尝试 6 次。检测会消耗上游模型额度；结果仅在当前指纹库的候选模型范围内归因，不能作为确定性证明。',
        start: '开始检测',
        running: '检测中…',
        progress: '总体进度',
        queueStatus: '队列状态',
        queuedCount: '排队 {count}',
        runningCount: '检测中 {count}',
      ...
      openai: {
        ...
        codexTurnTicketPaused: '暂无有效票据，该模型已暂停',
        codexTurnTicketRefresh: '立即重打',
        codexTurnTicketRefreshing: '打票中…',
        codexTurnTicketRefreshed: '已重新打票',
        codexTurnTicketRefreshFailed: '打票未成功，可稍后重试或检查采集代理',
