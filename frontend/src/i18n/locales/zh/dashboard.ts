export default {
  ...
  usage: {
    ...
    latencyDetail: {
      ...
      title: '请求耗时详情',
      loading: '正在加载详细耗时...',
      loadFailed: '加载请求耗时详情失败',
      unavailable: '此记录暂无分阶段耗时数据。历史记录或非 Responses 请求仍可查看首字和总耗时。',
      requestTotal: '请求总耗时',
      clientToGateway: '客户端 → sub2api',
      gateway: 'sub2api 内部',
      gatewayToUpstream: 'sub2api → 上游',
      result: '请求结果',
      bodyWait: '请求体首读等待',
      bodyRead: '请求体接收',
      bodySize: '请求体大小',
      uploadRate: '接收速率',
      handlerBodyRead: 'Handler 读取请求体',
      securityAudit: '安全审核',
      preflight: '预处理/鉴权',
      routing: '路由调度',
      largeRequestWait: '大请求排队',
      handlerTotal: 'Handler 总耗时',
      connectionAcquire: '连接获取',
      requestWrite: '写入上游请求',
      firstByteWait: '等待上游首字节',
      responseHeader: '上游响应头',
      firstToken: '首 Token',
      responseStream: '响应流传输',
      outcome: '结果',
      upstreamAttempts: '上游尝试次数',
      connectionReused: '连接复用',
      bodyComplete: '请求体完整接收',
      streamCompleted: '响应流完整',
      outcomeSuccess: '成功',
      outcomePartialError: '部分结果后出错',
      outcomeClientDisconnected: '客户端中断',
      outcomeUpstreamError: '上游错误',
      outcomeLargeRequestLimited: '大请求并发受限',
      outcomeRoutingError: '路由失败',
      outcomeRequestRejected: '请求被拒绝',
    },
    time: '时间',
    ws: 'WS',
    stream: '流式',
