export default {
    accounts: {
      ...
      toolActions: 'Tools',
      modelTrace: {
        launch: 'ModelTrace Detection',
        title: 'ModelTrace Model Attribution',
        description: 'Send numeric-choice challenges to each account test model and estimate the model family and version with the ModelTrace fingerprint bank.',
        all: 'All accounts',
        allHint: 'Detect every account in the system',
        selected: 'Selected accounts',
        selectedHint: 'Detect the {count} currently selected account(s)',
        selectedAccounts: 'Account IDs',
        accountIdsPlaceholder: 'Enter account IDs separated by commas, spaces, or new lines',
        detectionModel: 'Detection model',
        backendDefaultModel: 'Backend default model ({model})',
        platformDefaultModel: 'Selected by account platform',
        customModel: 'Custom model ID',
        customModelPlaceholder: 'For example: gpt-5.4 or claude-sonnet-4-6',
        detectionModelHint: 'Choose a model directly. “Backend default model” uses the Feature Switches setting, or the platform default when it is empty.',
        resultSearchPlaceholder: 'Search account, model, or attribution',
        resultFilterAll: 'All',
        resultFilterSuccess: 'Detected',
        resultFilterFailed: 'Failed',
        clearResults: 'Clear results',
        showingResults: 'Showing {shown} / {total}',
        noMatchingResults: 'No matching detection results',
        group: 'Account group',
        groupHint: 'Detect every account in the selected group',
        selectGroup: 'Select a group',
        usageNotice: 'The detector aims for 3 valid answers per account and tries up to 6 times. Requests consume upstream model quota. Results are limited to candidates in the current fingerprint bank and are not definitive proof.',
        ...
        concurrency: 'Concurrency limit {count}',
        ...
        outputsLabel: 'Valid outputs',
        latencyLabel: 'Duration',
        summary: 'Attribution summary',
        detected: 'Detected',
        failed: 'Failed',
        method: 'Method',
        predictionCount: '{count} account(s)',
        account: 'Account',
        model: 'Test model',
        prediction: 'Attribution',
        samples: 'Valid answers',
        family: 'Family',
        attempts: '{count} attempt(s)',
        noAccounts: 'No accounts in this scope',
        total: '{count} account(s) processed'
      },
      viewColumns: 'Columns',
      ...
      openai: {
        ...
        codexTurnTicketRefresh: 'Re-mint now',
        codexTurnTicketRefreshing: 'Minting…',
        codexTurnTicketRefreshed: 'Tickets re-minted',
        codexTurnTicketRefreshFailed: 'Minting failed; retry later or check the harvest proxy',
