export default {
  ...
  usage: {
    ...
    latencyDetail: {
      open: 'View detailed timing',
      title: 'Request timing details',
      loading: 'Loading detailed timing...',
      loadFailed: 'Failed to load request timing details',
      unavailable: 'No stage timing is available for this record. Historical or non-Responses records still show first-token and total duration.',
      requestTotal: 'Request total',
      clientToGateway: 'Client → sub2api',
      gateway: 'Inside sub2api',
      gatewayToUpstream: 'sub2api → upstream',
      result: 'Request result',
      bodyWait: 'Body first-read wait',
      bodyRead: 'Body receive',
      bodySize: 'Body size',
      uploadRate: 'Receive rate',
      handlerBodyRead: 'Handler body read',
      securityAudit: 'Security audit',
      preflight: 'Preflight/auth',
      routing: 'Routing',
      largeRequestWait: 'Large-request queue',
      handlerTotal: 'Handler total',
      connectionAcquire: 'Connection acquire',
      requestWrite: 'Upstream request write',
      firstByteWait: 'Upstream first-byte wait',
      responseHeader: 'Upstream response headers',
      firstToken: 'First token',
      responseStream: 'Response streaming',
      outcome: 'Outcome',
      upstreamAttempts: 'Upstream attempts',
      connectionReused: 'Connection reused',
      bodyComplete: 'Body fully received',
      streamCompleted: 'Stream completed',
      outcomeSuccess: 'Success',
      outcomePartialError: 'Error after partial result',
      outcomeClientDisconnected: 'Client disconnected',
      outcomeUpstreamError: 'Upstream error',
      outcomeLargeRequestLimited: 'Large-request concurrency limited',
      outcomeRoutingError: 'Routing failed',
      outcomeRequestRejected: 'Request rejected',
    },
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
